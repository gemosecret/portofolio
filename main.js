...
let projects = [
  {
    image: "textures/project-image01.png",
    url: "https://alphapuesta.net",
  },
  {
    image: "textures/project-image02.png",
    url: "https://vivaslots.co.za",
  },
  {
    image: "textures/project-image03.png",
    url: "http://hulkcars.com",
  },
  {
    image: "textures/project-image04.png",
    url: "https://www.olivespa.co.jp",
  },
  {
    image: "textures/project-image05.png",
    url: "https://www.superslots.ag",
  },
  {
    image: "textures/project-image06.png",
    url: "https://nft.corsac.app",
  },
  {
    image: "textures/project-image07.png",
    url: "https://www.kryptomon.co",
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load("fonts/unione.json", function (font) {
    ...
    const titleGeo = new TextGeometry("Gemo Secret", {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load("fonts/helvatica.json", function (font) {
    ...
    const subTitleGeo = new TextGeometry("Web Developer & Mobile Developer", {
      font: font,
      size: 0.018,
      height: 0,
    });
